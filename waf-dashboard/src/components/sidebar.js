...
export default function Sidebar({ activeView, setActiveView }) {
  const menuItems = [
    ...
    { id: "threats",   icon: <ShieldAlert size={18} />,     label: "Threats",     badge: "12" },
    { id: "analytics", icon: <BarChart3 size={18} />,      label: "Analytics",   badge: null },
    { id: "rules",     icon: <ShieldCheck size={18} />,     label: "Rules",       badge: "NEW" },
    { id: "ai",        icon: <MessageSquare size={18} />,   label: "AI Analyst",  badge: "BETA" },
    { id: "reporting", icon: <FileText size={18} />,       label: "Reporting",   badge: null },
    { id: "livelog",   icon: <Terminal size={18} />,       label: "Forensic Logs", badge: "LIVE" },
        ...
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-6 bg-primary rounded-r-full shadow-[0_0_10px_var(--primary-glow)]" />
              )}
